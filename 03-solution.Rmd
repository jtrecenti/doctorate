...
```{r tjmg2, fig.height=1.5, fig.width=4, fig.cap='CAPTCHA do TJMG após segmentação.', echo=FALSE}
...
```{r generalize, echo=FALSE, out.width = '32%', fig.cap="CAPTCHA Receita Federal", fig.align="center"}
fs::dir_ls('imgs/captcha/rfb')[1] %>% 
...
```{r emoji-horiz, no.mar=TRUE, out.width="30%", fig.cap="Figura após aplicação de convolução.", echo=FALSE, eval=TRUE, fig.align="center"}
...
```{r, no.mar=TRUE, out.width="30%", echo=FALSE, eval=TRUE, fig.align="center"}
...
```{r, fig.height=1, fig.width=3.6, no.mar=TRUE, echo=FALSE, eval=TRUE, fig.align="center"}
