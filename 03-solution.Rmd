...
```{r, out.width="30%", echo=TRUE, no.mar=TRUE, eval=TRUE}
library(magrittr)
  "imgs/emoji3.png" %>% 
  magick::image_read() %>% 
  plot()
...
```{r emoji-horiz, no.mar=TRUE, out.width="30%", echo=FALSE, eval=TRUE}
...
```{r, no.mar=TRUE, out.width="30%", echo=FALSE, eval=TRUE}
...
```{r, fig.height=1, fig.width=3.6, no.mar=TRUE, echo=FALSE, eval=TRUE}
